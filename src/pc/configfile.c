...
unsigned int configKeySpeedkick[MAX_BINDS] = { 0x001D, VK_INVALID, VK_INVALID };
unsigned int configKeyQuickturn[MAX_BINDS] = { 0x002F, VK_INVALID, VK_INVALID };
...
static const struct ConfigOption options[] = {
    ...
    { .name = "key_speedkick", .type = CONFIG_TYPE_BIND, .uintValue = configKeySpeedkick },
    { .name = "key_quickturn", .type = CONFIG_TYPE_BIND, .uintValue = configKeyQuickturn },
